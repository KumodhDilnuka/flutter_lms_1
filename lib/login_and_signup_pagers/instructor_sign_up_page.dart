...
class _InstructorSignupPageState extends State<InstructorSignupPage> {
  ...
  Future<void> _signup() async {
    ...
    final emailExists = users.any((u) => u['email'] == _emailController.text);
    if (emailExists) {
      if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Instructor Sign Up Page')),
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              const Text('Instructor Sign Up Page', style: TextStyle(fontSize: 24)),
